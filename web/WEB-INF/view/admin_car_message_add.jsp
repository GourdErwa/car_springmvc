...
<head>
    <base href="<%=basePath%>">
    <title>添加车辆信息-${applicationScope.projectName}</title>
...
<div class="container">
    ...
    <div style="width: 50%;margin-left: 300px; text-align: center;">
        ...
        <form class="form-horizontal" method="post" action="<%=basePath%>addCar_Message.admin.do"
              enctype="multipart/form-data" role="form"
              name="AddCar_Message" id="AddCar_Message" onsubmit="return isHavaThisCar()">
            <h3>添加车辆明细</h3>
            <br>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="carfuel" name="carfuel"
                           placeholder="车辆油耗(格式为1.0、1.3...)" maxlength="3"
                           required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="file" id="carpicture" name="carpicture" required>
            ...
            <button class="btn btn-lg btn-primary " data-loading-text="添加中..." type="submit">添加此车辆明细</button>
        </form>
    </div>
    <!--弹出层end  新建车辆类别-->
